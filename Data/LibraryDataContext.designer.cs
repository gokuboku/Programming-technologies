...
namespace Data
{
    ...
    partial void OnFineAmountChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_event", Storage="_user", ThisKey="UserGuid,FineAmount", OtherKey="Guid,FineAmount", IsForeignKey=true)]
		public user user
		{
			get
			{
    ...
    partial void OnFineAmountChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_event", Storage="_events", ThisKey="Guid,FineAmount", OtherKey="UserGuid,FineAmount")]
		public EntitySet<@event> events
		{
			get
			{
